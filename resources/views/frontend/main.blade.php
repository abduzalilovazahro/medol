			...
			<div class="container">
				...
				<div class="new-cars-content">
					<div class="owl-carousel owl-theme" id="new-cars-carousel">
                        @foreach ($products->where('type' , 'new') as $product)
								...
								<div class="testimonial-description">
									<div class="testimonial-info">
										<div class="testimonial-img">
											<img src="{{ asset('frontend/assets/images/clients/c1.png') }}" alt="image of clients person" />
										</div><!--/.testimonial-img-->
			...
			<div class="container">
				<div class="brand-area">
					<div class="owl-carousel owl-theme brand-item">
                        ...
                        <div class="item">
							<a href="#">
								<img src="{{ asset('frontend/assets/images/brand/br1.png') }}" alt="brand-image" />
                                <p>
                                    {{ $brand->name }}
                                </p>
							</a>
